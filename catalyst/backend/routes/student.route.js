...
const { UploadOfferLetter, DeleteOfferLetter, DownloadOfferLetter } = require('../controllers/Student/offer-letter.controller.js');
...
const { getPRS, calculatePRS } = require('../controllers/AI/prs.controller.js');
...
// Route to download offer letter
router.get('/download-offer-letter/:jobId/:studentId', authenticateToken, DownloadOfferLetter);
