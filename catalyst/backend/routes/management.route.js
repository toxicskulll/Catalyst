...
const { AddTPO, AddManagement, AddStudent, AddHOD } = require('../controllers/Management/add-user.controller');
...
// add management, tpo, student, and hod
...
router.post('/add-hod', authenticateToken, AddHOD);
