...
const AddTPO = async (req, res) => {
  ...
  try {
    ...
    const subject = "Welcome to catalyst | Your Login Credentials as a TPO";
...
const AddManagement = async (req, res) => {
  ...
  try {
    ...
    const subject = "Welcome to catalyst | Your Login Credentials as a Management";
...
const AddStudent = async (req, res) => {
  ...
  try {
    ...
    const subject = "Welcome to catalyst | Your Login Credentials as a Student";
...
const AddHOD = async (req, res) => {
  const { email, first_name, number, department } = req.body;
  ...
  try {
    ...
    if (!department) {
      return res.json({ msg: "Department is required for HOD!" });
    }
    ...
    const subject = "Welcome to catalyst | Your Login Credentials as HOD";

    await sendMail(email, subject, html);
    return res.json({ msg: "HOD User Created!" });
  } catch (error) {
    console.log("management-user-add-hod => ", error);
    return res.json({ msg: "Internal Server Error!" });
  }
};
