...
const ResumeBuilder = lazy(() => import("./components/ResumeBuilder/ResumeBuilder.jsx"));
const CreateDrive = lazy(() => import("./components/PlacementDrive/CreateDrive.jsx"));
const DriveList = lazy(() => import("./components/PlacementDrive/DriveList.jsx"));
const DriveDetails = lazy(() => import("./components/PlacementDrive/DriveDetails.jsx"));
const DepartmentReport = lazy(() => import("./components/Reports/DepartmentReport.jsx"));
const OfferReport = lazy(() => import("./components/Reports/OfferReport.jsx"));
const StudentReport = lazy(() => import("./components/Reports/StudentReport.jsx"));
const Dashboard = lazy(() => import("./components/Analytics/Dashboard.jsx"));
const EmailGenerator = lazy(() => import("./components/AITools/EmailGenerator.jsx"));
const ResumeFilter = lazy(() => import("./components/AITools/ResumeFilter.jsx"));
const CareersPage = lazy(() => import("./pages/CareersPage.jsx"));
const CareersJobDetail = lazy(() => import("./pages/CareersJobDetail.jsx"));
const InterviewSimulator = lazy(() => import("./components/InterviewSimulator/InterviewSimulator.jsx"));
const PredictiveDashboard = lazy(() => import("./components/PredictiveAnalytics/PredictiveDashboard.jsx"));
const PRSDashboard = lazy(() => import("./components/PRS/PRSDashboard.jsx"));
const InterventionEngine = lazy(() => import("./components/Intervention/InterventionEngine.jsx"));
const CareerDNADashboard = lazy(() => import("./components/CareerDNA/CareerDNADashboard.jsx"));
const CultureMatch = lazy(() => import("./components/CareerDNA/CultureMatch.jsx"));
const Publications = lazy(() => import("./components/Students/Publications.jsx"));
const HODLogin = lazy(() => import("./pages/HOD/Login.jsx"));
const HODHome = lazy(() => import("./pages/HOD/Home.jsx"));
const ApproveStudents = lazy(() => import("./components/HOD/ApproveStudents.jsx"));
const DepartmentStudents = lazy(() => import("./components/HOD/DepartmentStudents.jsx"));
const OnboardingGuide = lazy(() => import("./components/Tutorial/OnboardingGuide.jsx"));
    ...
    <>
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex flex-grow">
          ...
          <div 
            className={`content flex-grow p-4 transition-all duration-300 ${isSidebarVisible ? 'md:ml-64' : 'ml-0'} overflow-hidden min-h-screen`}
            style={{
          ...
          >
            ...
            <div className="animate-fadeInUp route-wrapper">
              <Outlet />
            </div>
          </div>
        </div>
        ...
        {user && (
          <Suspense fallback={null}>
            <OnboardingGuide userRole={user.role} userId={user._id || user.id} />
          </Suspense>
        )}
      </div>
    </>
      ...
      <BrowserRouter>
        <Suspense fallback={<LoadingComponent />}>
          <Routes>
            ...
            <Route path="/careers/job/:jobId" element={<CareersJobDetail />} />
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['student']} /></UserProvider>}>
              ...
              {/* Resume Builder */}
              <Route element={<Layout header="Resume Builder" />}>
                <Route path="/student/resume-builder" element={<ResumeBuilder />} />
                <Route path="/student/resume-builder/:jobId" element={<ResumeBuilder />} />
              </Route>
              {/* Placement Drives */}
              <Route element={<Layout header="Placement Drives" />}>
                <Route path="/student/placement-drives" element={<DriveList />} />
                <Route path="/student/placement-drive/:driveId" element={<DriveDetails />} />
              </Route>
              {/* AI Interview Simulator */}
              <Route element={<Layout header="AI Interview Simulator" />}>
                <Route path="/student/interview-simulator" element={<InterviewSimulator />} />
                <Route path="/student/interview-simulator/:jobId" element={<InterviewSimulator />} />
              </Route>
              {/* Predictive Analytics */}
              <Route element={<Layout header="Placement Prediction" />}>
                <Route path="/student/prediction" element={<PredictiveDashboard />} />
                <Route path="/student/prediction/:jobId" element={<PredictiveDashboard />} />
              </Route>
              {/* PRS Dashboard */}
              <Route element={<Layout header="Placement Readiness Score" />}>
                <Route path="/student/prs" element={<PRSDashboard />} />
              </Route>
              {/* Intervention Engine */}
              <Route element={<Layout header="Intervention Engine" />}>
                <Route path="/student/interventions" element={<InterventionEngine />} />
              </Route>
              {/* Career DNA */}
              <Route element={<Layout header="Career DNA Profile" />}>
                <Route path="/student/career-dna" element={<CareerDNADashboard />} />
              </Route>
              <Route element={<Layout header="Culture Match" />}>
                <Route path="/student/culture-match/:jobId" element={<CultureMatch />} />
              </Route>
              {/* Publications */}
              <Route element={<Layout header="Research Publications" />}>
                <Route path="/student/publications" element={<Publications />} />
              </Route>
            </Route>
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['tpo_admin']} /></UserProvider>}>
              ...
              {/* Placement Drives */}
              <Route element={<Layout header="Placement Drives" />}>
                <Route path="/tpo/placement-drives" element={<DriveList />} />
                <Route path="/tpo/create-drive" element={<CreateDrive />} />
                <Route path="/tpo/placement-drive/:driveId" element={<DriveDetails />} />
              </Route>
              {/* Reports */}
              <Route element={<Layout header="Reports" />}>
                <Route path="/tpo/reports/department" element={<DepartmentReport />} />
                <Route path="/tpo/reports/offers" element={<OfferReport />} />
                <Route path="/tpo/reports/student/:studentId" element={<StudentReport />} />
              </Route>
              {/* Analytics */}
              <Route element={<Layout header="Analytics Dashboard" />}>
                <Route path="/tpo/analytics" element={<Dashboard />} />
              </Route>
              {/* AI Tools */}
              <Route element={<Layout header="AI Tools" />}>
                <Route path="/tpo/ai/email-generator" element={<EmailGenerator />} />
                <Route path="/tpo/ai/resume-filter" element={<ResumeFilter />} />
              </Route>
            </Route>

            {/* All HOD routes  */}
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['hod']} /></UserProvider>}>
              <Route element={<Layout header="Dashboard" />}>
                <Route path="/hod/dashboard" element={<HODHome />} />
              </Route>
              <Route element={<Layout header="Approve Students" />}>
                <Route path="/hod/approve-students" element={<ApproveStudents />} />
              </Route>
              <Route element={<Layout header="Department Students" />}>
                <Route path="/hod/students" element={<DepartmentStudents />} />
              </Route>
              <Route element={<Layout header="Department Reports" />}>
                <Route path="/hod/reports" element={<DepartmentReport />} />
              </Route>
              <Route element={<Layout header="Account Details" />}>
            ...
            <Route element={<UserProvider><ProtectedRoute allowedRoles={['management_admin']} /></UserProvider>}>
              ...
              {/* Reports */}
              <Route element={<Layout header="Reports" />}>
                <Route path="/management/reports/department" element={<DepartmentReport />} />
              </Route>
            </Route>
