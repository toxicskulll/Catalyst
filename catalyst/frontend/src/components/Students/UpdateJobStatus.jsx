...
function UpdateJobStatus() {
  document.title = 'catalyst | Update Job Application Status';
                        ...
                        <div className="grid grid-cols-2 gap-4 max-sm:grid-cols-1">
                          ...
                          <div className="flex flex-col gap-2 justify-center items-center">
                            ...
                            <UploadOfferLetter jobId={jobId} fetchJobDetailsOfApplicant={fetchJobDetailsOfApplicant} />
                            {
                              ...
                              <div className="cursor-pointer w-fit flex gap-2 justify-between items-center">
                                <span
                                ...
                                <span
                                  className='bg-green-500 px-3 py-1 rounded transition duration-300 ease-in-out hover:bg-green-700'
                                >
                                  <a
                                    className='text-white no-underline flex justify-center items-center'
                                    href={`${BASE_URL}/student/download-offer-letter/${jobId}/${currentUser.id}`}
                                    download
                                  >
